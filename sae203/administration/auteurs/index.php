...
<body>
    ...
    <header class="bg-white shadow">
        ...
        <?php $nombreAuteur = $clientMySQL ->query("SELECT COUNT(*) AS 'NumberOfAut' FROM auteur");?> 
        <p class="text-gray-500 mb-2">Nombre d'auteurs :  <?php echo $nombreAuteur ->fetch() ["NumberOfAut"] ?> </p>
        </div>
    </header>
    <main>
        <div class="mx-auto max-w-7xl py-6">
                ...
                <table class="w-full bg-white rounded-lg overflow-hidden border-collapse shadow">
                    <thead class="bg-gray-100">
                        <tr class="">
                            ...
                            <th class="font-bold pl-8 py-5 text-left">LinkedIn</th>
                        ...
                        <?php foreach ($listeAuteurs as $auteur) {
                            $lienEdition = "{$racineURL}/edition.php?id={$auteur['id']}"; ?>
                                <tr class="hover:bg-gray-100 border-b-2 border-b-gray-100 last:border-b-0 first:border-t-2 first:border-t-gray-200">
                                    <td class="pl-8 p-4 font-bold"><?php echo $auteur[ 'id' ]; ?></td>
