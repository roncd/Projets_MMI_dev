...
<?php include_once '../ressources/includes/menu-principal.php'; ?>
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-6">
            ...
            <?php $nombredemessages = $clientMySQL ->query("SELECT COUNT(*) AS 'NumberOfMsg' FROM message");?> 
            <p class="text-gray-500">Nombre de messages :  <?php echo $nombredemessages ->fetch() ["NumberOfMsg"] ?> </p>
            </div>
        </div>
