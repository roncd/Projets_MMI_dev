    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section class="colonne">
            ...
            <?php foreach ($listeArticles as $article) { ?>
                    ...
                    <a href="article.php?id=<?php echo $article["id"]; ?>" class="ancienne-classe article bg-white hover:bg-gray-200">
                        <figure>
                        <img src='ressources/images/image-article.png' alt='' class="w-full transition-transform duration-200 ease-in-out transform hover:scale-95">
                        </figure>
                        <section class='textes'>
                            <h1 class='titre transition-colors duration-200 ease-in-out hover:text-pink-500'><?php echo $article["titre"]; ?></h1>
                            <p class='description'>
